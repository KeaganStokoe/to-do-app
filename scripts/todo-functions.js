...
//Read and parse previously saved todos
 const getSavedTodos = () => {
 ...
 const renderTodos = (todos, filters) => {
    ...
    if (filteredTodos.length > 0) {
        ...
        emptyTodos.textContent = "You've got a clear schedule! Get some rest."
...
//Function to toggle todo checkbox
const toggleTodo = (id) => {
...
const generateSummaryDOM = (incompleteTodos) => {
    ...
    summary.textContent = `You have ${incompleteTodos.length} todo${plural} remaining.`  
    return summary
}